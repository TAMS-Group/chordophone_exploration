...
class RuckigPath:
    class ActionSpace(NamedTuple):
        ...
        # each of these is a tuple with lower/upper limit
        ...
        # was the object generated by with_direction() to declare whether this space is for forward or backward plucks?
        directed: bool = False
